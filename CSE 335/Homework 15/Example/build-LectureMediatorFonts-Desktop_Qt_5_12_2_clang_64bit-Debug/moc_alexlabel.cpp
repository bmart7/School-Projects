...
void AlexLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AlexLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AlexLabel::staticMetaObject = { {
    &QLabel::staticMetaObject,
    qt_meta_stringdata_AlexLabel.data,
    qt_meta_data_AlexLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
