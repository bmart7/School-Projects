...
#include "../DistributedCollaboration/newlineedit.h"
...
QT_MOC_LITERAL(1, 12, 19), // "setTextFromComboBox"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 5) // "index"

    },
    "NewLineEdit\0setTextFromComboBox\0\0index"
};
...
void NewLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setTextFromComboBox((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
